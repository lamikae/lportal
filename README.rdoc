...
# <tt>gem install lportal</tt> # version 1.0.18
# Configure ActiveRecord to use the Liferay database. See example configurations[http://github.com/lamikae/lportal/tree/master/config/].
# <tt>require 'lportal'</tt>
# You're good to go.
