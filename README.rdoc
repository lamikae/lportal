...
NOTICE: Github contains impartial import, which does not include branches that are stored at Rubyforge.
For running the stable 1.0 branch from git:
...
== Other databases
Run the code from the master branch:
